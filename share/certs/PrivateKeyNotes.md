...
unlocked to sign the Ion-Qt.app bundle.
...
allowing somebody to distribute a Ion-Qt.app or ion-qt-setup.exe with a valid
...
that the ion-qt.exe file inside the installer had not been tampered with.
