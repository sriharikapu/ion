    ...
    BOOST_FOREACH (PAIRTYPE(int, CMasternode) & s, vMasternodeRanks) {
        ...
        if (mn != NULL) {
            if (strFilter != "" && strTxHash.find(strFilter) == string::npos &&
                ...
                CIonAddress(mn->pubKeyCollateralAddress.GetID()).ToString().find(strFilter) == string::npos) continue;
            ...
            obj.push_back(Pair("addr", CIonAddress(mn->pubKeyCollateralAddress.GetID()).ToString()));
...
UniValue masternodecurrent (const UniValue& params, bool fHelp)
{
    ...
    if (winner) {
        ...
        obj.push_back(Pair("pubkey", CIonAddress(winner->pubKeyCollateralAddress.GetID()).ToString()));
...
UniValue getmasternodestatus (const UniValue& params, bool fHelp)
{
    ...
    if (pmn) {
        ...
        mnObj.push_back(Pair("addr", CIonAddress(pmn->pubKeyCollateralAddress.GetID()).ToString()));
