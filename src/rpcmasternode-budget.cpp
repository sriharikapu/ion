...
UniValue preparebudget(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() != 6)
        throw runtime_error(
            ...
            "\nExamples:\n" +
            HelpExampleCli("preparebudget", "\"test-proposal\" \"https://forum.ionomy.com/t/test-proposal\" 2 820800 \"idaeAtzaCGnJ5SUPXKoFxtgzbvv5nfBSDn\" 500") +
            HelpExampleRpc("preparebudget", "\"test-proposal\" \"https://forum.ionomy.com/t/test-proposal\" 2 820800 \"idaeAtzaCGnJ5SUPXKoFxtgzbvv5nfBSDn\" 500"));
    ...
    CIonAddress address(params[4].get_str());
    if (!address.IsValid())
...
UniValue submitbudget(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() != 7)
        throw runtime_error(
            ...
            "\nExamples:\n" +
            HelpExampleCli("submitbudget", "\"test-proposal\" \"https://forum.ionomy.com/t/test-proposal\" 2 820800 \"idaeAtzaCGnJ5SUPXKoFxtgzbvv5nfBSDn\" 500") +
            HelpExampleRpc("submitbudget", "\"test-proposal\" \"https://forum.ionomy.com/t/test-proposal\" 2 820800 \"idaeAtzaCGnJ5SUPXKoFxtgzbvv5nfBSDn\" 500"));
