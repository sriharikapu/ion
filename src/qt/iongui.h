...
#ifndef ION_QT_IONGUI_H
#define ION_QT_IONGUI_H
...
*/
class IonGUI : public QMainWindow
{
    Q_OBJECT
...
public:
    ...
    explicit IonGUI(const NetworkStyle* networkStyle, QWidget* parent = 0);
    ~IonGUI();
    ...
    */
    ...
    /** Set the wallet model.
        The wallet model represents a ion wallet, and offers access to the list of transactions, address book and sending
        functionality.
    */
