...
UniValue listmintedzerocoins(const UniValue& params, bool fHelp)
{
    ...
    CWalletDB walletdb(pwalletMain->strWalletFile);
    list<CMintMeta> listPubCoin = pwalletMain->xionTracker->ListMints(true, false, true);
...
UniValue listzerocoinamounts(const UniValue& params, bool fHelp)
{
    ...
    CWalletDB walletdb(pwalletMain->strWalletFile);
    list<CMintMeta> listMints = pwalletMain->xionTracker->ListMints(true, true, true);
...
UniValue resetmintzerocoin(const UniValue& params, bool fHelp)
{
    ...
    list<CMintMeta> listMints = xionTracker->ListMints(false, false, true);
...
UniValue resetspentzerocoin(const UniValue& params, bool fHelp)
{
    ...
    CWalletDB walletdb(pwalletMain->strWalletFile);
    CxIONTracker* xionTracker = pwalletMain->xionTracker;
    list<CMintMeta> listMints = xionTracker->ListMints(false, false, false);
...
UniValue exportzerocoins(const UniValue& params, bool fHelp)
{
    ...
    CxIONTracker* xionTracker = pwalletMain->xionTracker;
    list<CMintMeta> listMints = xionTracker->ListMints(!fIncludeSpent, false, false);
