...
if [ $# -lt 1 ]; then
        ...
        echo "e.g. $0 ../../src"
        echo "Env vars IOND and IONCLI may be used to specify the exact binaries used"
        exit 1
fi
...
$IOND -zapwallettxes=1 $B1ARGS &
B1PID=$!
$IOND -zapwallettxes=2 $B2ARGS &
B2PID=$!
